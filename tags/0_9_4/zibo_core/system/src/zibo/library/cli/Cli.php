...
class Cli {
     ...
     * @return bool true if we are running the command line interface, false otherwise
     */
     ...
     * @return mixed the value of the argument or the provided default value when the argument is not set
     */
