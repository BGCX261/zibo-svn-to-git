...
class ExtendedCache extends AbstractCache {
     ...
     * @param zibo\library\cache\io\CacheIO $io I/O implementation for this cache, default is a File implementation in application/data/cache
     * @return null
     */
     ...
     * @param int $times Number of times a cache object can be accessed before it's cleared. Set to null or 0 to skip the access number check
     * @return null
    ...
    public function setCleanUpTimes($times) {
        ...
        if (Number::isNegative($times)) {
            throw new ZiboException('Provided clean up times is negative');
        }
     ...
     * @return boolean True if the cache objects needs to be cleared, false otherwise
     */
