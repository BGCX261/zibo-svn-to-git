...
class Document extends DOMDocument {
    ...
    /**
     * Set the file name of the validation schema through the Zibo configuration
     * @param string $configKey configuration key for the validation schema
     * @return null
     */
    public function setSchemaFileFromConfig($configKey) {
        $this->schemaFile = Zibo::getInstance()->getConfigValue($configKey);
    }
     ...
     * @return null
     */
    public function setRelaxNGFileFromConfig($configKey) {
        $this->relaxNGFile = Zibo::getInstance()->getConfigValue($configKey);
    }
     ...
     * @throws zibo\library\xml\exception\LibXmlException when the file could not be loaded or validated
     */
     ...
     * @throws zibo\library\xml\exception\LibXmlException when the source could not be loaded or validated
     */
     ...
     * @param string $source source of the document of file name of the source, needed for the exception if thrown
     * @return null
     * @throws zibo\library\xml\exception\LibXmlException when the document is not validated by a set validation schema
     */
     ...
     * @return null
     * @throws zibo\library\xml\exceptin\LibXmlException
     */
