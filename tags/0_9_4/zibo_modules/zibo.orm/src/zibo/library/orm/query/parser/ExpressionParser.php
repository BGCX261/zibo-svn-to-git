...
use zibo\library\orm\exception\OrmParseException;
use zibo\library\orm\query\tokenizer\ConditionTokenizer;
use zibo\library\orm\query\tokenizer\FieldTokenizer;
use zibo\library\orm\query\tokenizer\MathematicTokenizer;
use zibo\library\orm\query\ModelExpression;
...
class ExpressionParser {
     ...
     * @var zibo\library\orm\query\tokenizer\MathematicTokenizer
     */
    private $mathematicTokenizer;

    /**
     * Tokenizer for conditions
     * @var zibo\library\orm\query\tokenizer\ConditionTokenizer
     */
     ...
     * @param zibo\library\orm\query\tokenizer\FieldTokenizer $fieldTokenizer
     * @param zibo\library\orm\query\tokenizer\MathematicTokenizer $mathematicTokenizer
     * @param zibo\library\orm\query\tokenizer\ConditionTokenizer $conditionTokenizer
     * @return null
     */
     ...
     * @param zibo\library\orm\query\ModelExpression $condition Condition to parse
     * @return zibo\library\database\manipulation\condition\Condition
     */
     ...
     * @return zibo\library\database\manipulation\condition\SimpleCondition
     * @throws zibo\library\orm\exception\OrmParseException when the provided condition is empty or invalid
     */
     ...
     * @return boolean|zibo\library\database\manipulation\expression\FieldExpression false if the
     ...
     * @return boolean|zibo\library\database\manipulation\expression\ScalarExpression false if the
     ...
     * @return zibo\library\database\manipulation\expression\SqlExpresison
     */
