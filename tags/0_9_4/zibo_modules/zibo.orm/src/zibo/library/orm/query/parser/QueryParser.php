...
use zibo\library\orm\query\ModelJoin;
...
class QueryParser {
     ...
     * @var zibo\library\database\manipulation\statement\SelectStatement
     */
    private $statement;
     ...
     * @return null
     */
    public function __construct(FieldTokenizer $fieldTokenizer = null) {
        if (!$fieldTokenizer) {
...
//        $this->addGroupBy($groupBy);
     ...
     * @param zibo\library\database\manipulation\expression\Expression $expression Expression to process
     * @param boolean $inCondition Flag to see whether the provided expression is used in a condition or not
     * @return zibo\library\database\manipulation\expression\Expression Processed expression
     */
...
//        }
     ...
     * @param zibo\library\database\manipulation\condition\Condition $condition Condition to process
     * @return zibo\library\database\manipulation\condition\Condition Processed condition
     */
     ...
     * @param zibo\library\orm\query\ModelExpression $condition
     */
     ...
     * @return zibo\library\database\manipulation\expression\OrderExpression
     */
     ...
     * @return zibo\library\database\manipulation\expression\TableExpression
     */
     ...
     * @param zibo\library\orm\definition\field\RelationField $field
     * @return null
     */
     ...
     * @param zibo\library\database\manipulation\expression\JoinExpression $join
     * @return null
     */
