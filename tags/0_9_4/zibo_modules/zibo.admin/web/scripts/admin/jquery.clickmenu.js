...
//							alert('offsetWidth: ' + div.offsetWidth + '; width: ' + $(div).width() + '; screen: ' + $(window).width());
//							alert('new left: ' + left + '; offsetWidth: ' + div.parentNode.offsetWidth + '; liOffset: ' + liOffset);
...
//								$(div).css('left', div.parentNode.offsetWidth - liOffset);
		...
		var mainClick = function ()
		{
			...
			{
				hoverIn(this, settings.mainDelay);
//				alert(this.settings.start);
				if (settings.start == 'right') {
					var width = $(this).width();
					$(div).css('left', settings.arrowWidth - width - 40);
				}
				shown = true;
