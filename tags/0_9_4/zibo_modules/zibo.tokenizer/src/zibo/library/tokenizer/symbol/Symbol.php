...
interface Symbol {
     ...
     *
     * The argument inProcess is passed by reference. When processing more then the inProcess argument, concat the processed substring from
     * the toProcess argument to the inProcess argument to make the tokenizer skip the processed part.
