...
/**
 * Spider report of all the gathered CSS stylesheets
 */
class CssReport implements SpiderReport {

    /**
     * Translation key for the title of this report
     * @var string
     */
    const TRANSLATION_TITLE = 'spider.title.report.css';
    ...
    public function setWeb(Web $web) {
        ...
        foreach ($nodes as $node) {
            if (!$node->hasType(WebNode::TYPE_CSS) || $node->hasType(WebNode::TYPE_IGNORED)) {
                continue;
            }
