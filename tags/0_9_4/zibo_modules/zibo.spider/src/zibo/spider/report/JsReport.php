...
/**
 * Spider report of all the gathered javascripts
 */
class JsReport implements SpiderReport {

    /**
     * Translation key for the title of this report
     * @var string
     */
    const TRANSLATION_TITLE = 'spider.title.report.js';
    ...
    public function setWeb(Web $web) {
        ...
        foreach ($nodes as $node) {
            if (!$node->hasType(WebNode::TYPE_JS) || $node->hasType(WebNode::TYPE_IGNORED)) {
                continue;
            }
