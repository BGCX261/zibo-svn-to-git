...
/**
 * Spider report of all the gathered images
 */
class ImageReport implements SpiderReport {

    /**
     * Translation key for the title of this report
     * @var string
     */
    const TRANSLATION_TITLE = 'spider.title.report.image';
    ...
    public function setWeb(Web $web) {
        ...
        foreach ($nodes as $node) {
            if (!$node->hasType(WebNode::TYPE_IMAGE) || $node->hasType(WebNode::TYPE_IGNORED)) {
                continue;
            }
