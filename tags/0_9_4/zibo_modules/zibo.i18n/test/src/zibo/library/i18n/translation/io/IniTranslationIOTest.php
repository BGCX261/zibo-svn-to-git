...
class IniTranslationIOTest extends BaseTestCase {
    ...
    public function testGetAllTranslationsReturnsAllTranslationsAsArray() {
        $translations = $this->io->getAllTranslations('nl');
