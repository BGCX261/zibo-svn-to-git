...
class LocaleTest extends BaseTestCase {
     ...
     */
    public function testConstructThrowsExceptionWhenInvalidValuePassed($code, $name, $native, $plural) {
        new Locale($code, $name, $native);
    }

    public function providerConstructThrowsExceptionWhenInvalidValuePassed() {
        return array(
            array('code', 'name', '', 'plural'),
            array('code', '', 'native', 'plural'),
            array('', 'name', 'native', 'plural'),
        );
    }
    ...
    public function testGetDateFormatsReturnsAvailableDateFormats() {
        ...
        $this->assertType('array', $dateFormats);
