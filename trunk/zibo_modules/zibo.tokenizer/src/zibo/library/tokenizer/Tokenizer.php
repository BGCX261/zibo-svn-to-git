...
namespace zibo\library\tokenizer;

use zibo\library\tokenizer\symbol\Symbol;
...
class Tokenizer {
     ...
     * @param zibo\library\tokenizer\symbol\Symbol $symbol
     * @return null
     */
...
//                    $toProcess = substr($toProcess, strlen($process));
    ...
    /**
     * Gets whether this tokenizer will trim tokens. Tokens which are empty after trimming will be removed.
     * Nested tokens are untouched.
     * @return boolean
     */
    ...
    /**
     * Trims the provided tokens. Tokens which are empty after trimming will be removed. Nested tokens
     * are untouched.
     * @param array $tokens
     * @return array
     */
