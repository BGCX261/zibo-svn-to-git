 ...
 */
class UninstallActionDecorator extends ActionDecorator {

    /**
     * Translation key for the label of the action
     * @var string
     */
    const TRANSLATION_LABEL = 'modules.button.uninstall';

    /**
     * Translation key for the confirmation message of this action
     * @var string
     */
    const TRANSLATION_MESSAGE = 'modules.label.uninstall.confirm';
