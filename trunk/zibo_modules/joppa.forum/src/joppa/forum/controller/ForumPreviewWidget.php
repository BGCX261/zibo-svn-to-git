...
/**
 * Widget to show a preview of the last posts in the forum
 */
class ForumPreviewWidget extends AbstractWidget {

	/**
	 * Translation key for the name of this widget
	 * @var string
	 */
	const TRANSLATION_NAME = 'joppa.forum.title.widget.preview';

	/**
	 * Translation key for the posts label of the preview
	 * @var string
	 */
	const TRANSLATION_POSTS = 'joppa.forum.label.properties.posts.preview';

	/**
	 * Name of the property which defines the number of posts to display
	 * @var string
	 */
	const PROPERTY_POSTS = 'posts';

    /**
     * Default value for the posts property
     * @var integer
     */
