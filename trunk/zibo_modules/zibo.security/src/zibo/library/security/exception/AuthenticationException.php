...
namespace zibo\library\security\exception;
...
class AuthenticationException extends SecurityException {
     ...
     * @return null
     * @throws zibo\ZiboException when the provided field name id not username, password or null
     */
    private function setField($field) {
        ...
        throw new ZiboException('Invalid field provided: username, password or null');
    }
