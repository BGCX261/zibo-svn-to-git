...
use zibo\orm\scaffold\view\LogView;

/**
 * View for a data form
 */
class ScaffoldManagerFormView extends SmartyView {
    ...
    protected function setLocalizeSubview(ModelMeta $meta, $data, $action = null) {
        ...
        $this->addJavascript('web/scripts/admin/form.js');
        $this->addInlineJavascript("$(function() { ZiboForm('" . $form->getId() . "'); });");
