...
use zibo\library\mail\transport\Transport;
...
class Message {
    ...
    /**
     * Configuration key for the default transport
     * @var string
     */
    const CONFIG_TRANSPORT = 'mail.transport';

    /**
     * Class name of the transport interface
     * @var string
     */
    const INTERFACE_TRANSPORT = 'zibo\\library\\mail\\transport\\Transport';

    /**
     * Default transport implementation for when no configuration is set
     * @var string
     */
    const DEFAULT_TRANSPORT = 'zibo\\library\\mail\\transport\\SimpleTransport';
    ...
    /**
     * Sets the sender
     * @param string|Address $from The address of the sender
     * @return null
     */
    ...
    /**
     * Sets the recipients
     * @param string|Address|array $to The address(es) of the recipient(s)
     * @return null
     */
     ...
     * @param string|Address|array $cc The address(es) of the recipient(s)
     * @return null
     */
     ...
     * @param string|Address $replyTo Address to reply to
     * @return null
     */
     ...
     * @return null|Address Address to reply to
     */
     ...
     * @param string|Address $returnPath The return path address
     * @return null
     */
     ...
     * @return null|Address The return path of this message
     */
    ...
    public function setIsHtmlMessage($isHtmlMessage) {
        ...
        if ($isHtmlMessage && !array_key_exists(self::PART_ALTERNATIVE, $this->parts)) {
        ...
        } elseif (!$isHtmlMessage && array_key_exists(self::PART_ALTERNATIVE, $this->parts)) {
     ...
     * @return null
     * @throws zibo\library\mail\exception\MailException when the part could not be found
     */
     ...
     * @return null
     * @throws zibo\library\mail\exception\MailException When the provided value is invalid
     */
     ...
     * @param string|Address|array $addresses The addresses in a string or a object
     ...
     * @param string|Address $address The address in a string or a object
     * @return Address The provided address as a object
     */
