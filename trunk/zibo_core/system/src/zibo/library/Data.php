...
class Data implements Iterator {
    ...
    public function __get($name) {
        ...
        if ($this->variables && array_key_exists($name, $this->variables)) {
    ...
    public function __isset($name) {
        ...
        return $this->variables && array_key_exists($name, $this->variables);
    }
    ...
    public function __unset($name) {
        $methodName = $this->getMethodName($name, 'set');
        if (method_exists($this, $methodName)) {
            throw new ZiboException('Cannot unset ' . $name . ', use ' . $methodName . ' instead');
        }
